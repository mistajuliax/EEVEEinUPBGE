...
#include "BLI_listbase.h" // Game engine transition
#include "DNA_object_types.h" // Game engine transition (fixes a compil error with ObjectEngineData)

struct Object;
struct EEVEE_BoundSphere;
struct EEVEE_ShadowCasterBuffer;

struct Material; // Game engine transition
